...
plot(stm, type = "perspectives", topics = 1)

plot(stm, type = "perspectives", topics = c(1,2))
...
plot(est, "date", method="continuous", topics=1:2,
	xaxt="n")
dates <- seq(from = as.Date("2014-01-01"), to = as.Date("2014-12-31"), by="2 months")
